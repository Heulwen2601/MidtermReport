...
class DealTerms extends \Google\Model
{
  ...
  protected $guaranteedFixedPriceTermsType = DealTermTDTUaranteedFixedPriceTerms::class;
  ...
  /**
   * @param DealTermTDTUaranteedFixedPriceTerms
   */
  public function setGuaranteedFixedPriceTerms(DealTermTDTUaranteedFixedPriceTerms $guaranteedFixedPriceTerms)
  {
    $this->guaranteedFixedPriceTerms = $guaranteedFixedPriceTerms;
  }
  /**
   * @return DealTermTDTUaranteedFixedPriceTerms
   */
