...
class ApiDeployment extends \Google\Model
{
   ...
   * @param string
   */
  public function setAccesTDTUidance($accesTDTUidance)
  {
    $this->accesTDTUidance = $accesTDTUidance;
  }
  /**
   * @return string
   */
  public function getAccesTDTUidance()
  {
    return $this->accesTDTUidance;
  }
  /**
   * @param string[]
   */
