 ...
 *  </code>
 */
class UserProfileTDTUardians extends \Google\Service\Resource
{
  /**
   ...
   * has no record of that student. (guardians.listUserProfileTDTUardians)
   *
   ...
   */
  public function listUserProfileTDTUardians($studentId, $optParams = [])
  {
...
class_alias(UserProfileTDTUardians::class, 'Google_Service_Classroom_Resource_UserProfileTDTUardians');
