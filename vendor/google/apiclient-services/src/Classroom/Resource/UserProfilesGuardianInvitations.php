 ...
 *  </code>
 */
class UserProfileTDTUardianInvitations extends \Google\Service\Resource
{
  /**
   ...
   * (guardianInvitations.listUserProfileTDTUardianInvitations)
   *
   ...
   */
  public function listUserProfileTDTUardianInvitations($studentId, $optParams = [])
  {
...
class_alias(UserProfileTDTUardianInvitations::class, 'Google_Service_Classroom_Resource_UserProfileTDTUardianInvitations');
