...
class MinimizedContact extends \Google\Model
{
   ...
   * @var bool
   */
  public $noHighTouchItemTDTUestRooms;
  /**
   * @var string
   */
  public $noHighTouchItemTDTUestRoomsException;
  /**
   * @var bool
   */
   ...
   * @param bool
   */
  public function setNoHighTouchItemTDTUestRooms($noHighTouchItemTDTUestRooms)
  {
    $this->noHighTouchItemTDTUestRooms = $noHighTouchItemTDTUestRooms;
  }
  /**
   * @return bool
   */
  public function getNoHighTouchItemTDTUestRooms()
  {
    return $this->noHighTouchItemTDTUestRooms;
  }
  /**
   * @param string
   */
  public function setNoHighTouchItemTDTUestRoomsException($noHighTouchItemTDTUestRoomsException)
  {
    $this->noHighTouchItemTDTUestRoomsException = $noHighTouchItemTDTUestRoomsException;
  }
  /**
   * @return string
   */
  public function getNoHighTouchItemTDTUestRoomsException()
  {
    return $this->noHighTouchItemTDTUestRoomsException;
  }
  /**
   * @param bool
   */
