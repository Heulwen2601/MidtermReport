...
class Classroom extends \Google\Service
{
  ...
  public function __construct($clientOrConfig = [], $rootUrl = null)
  {
    ...
    $this->userProfiles_guardianInvitations = new Classroom\Resource\UserProfileTDTUardianInvitations(
        $this,
        $this->serviceName,
        'guardianInvitations',
        [
    ...
    $this->userProfiles_guardians = new Classroom\Resource\UserProfileTDTUardians(
        $this,
        $this->serviceName,
        'guardians',
        [
